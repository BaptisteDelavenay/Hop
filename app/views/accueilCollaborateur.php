...
<body class="bg-hop-violet min-h-dvh">
    ...
    <div class="js-CompteModal fixed top-0 left-0 h-full w-full bg-black/50 p-4">
        <div class="bg-white h-40 rounded-2xl flex flex-col">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 float-right"><path stroke-linecap="round" stroke-linejoin="round" d="M6 18 18 6M6 6l12 12" /></svg>

            <div class="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6"><path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.501 20.118a7.5 7.5 0 0 1 14.998 0A17.933 17.933 0 0 1 12 21.75c-2.676 0-5.216-.584-7.499-1.632Z" /></svg>
                <p class="text-xl font-bold">Profil utilisateur</p>
            </div>
            <div class="flex items-center">
                ...
                <p class="text-xl font-bold">Se déconnecter</p>
            </div>
        </div>
    </div>
