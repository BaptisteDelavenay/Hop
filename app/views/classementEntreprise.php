...
<body class="bg-hop-violet flex flex-col min-h-dvh">
    ...
    <section class="flex justify-evenly pt-10">
        <div class="flex flex-col justify-end items-center gap-2">
            <div class="overflow-hidden flex items-center justify-center rounded-full h-25 w-25"><img class="h-full w-full scale-110 object-cover" src="<?= isset($userListEntreprise[1]["photo_profil"]) ? $userListEntreprise[1]["photo_profil"] : "../../IMG/default.png" ?>" alt="photo de profil"></div>
            <p class="text-white font-bold"><?= isset($userListEntreprise[1]["prenom"]) ? $userListEntreprise[1]["prenom"] : "" ?> <?= isset($userListEntreprise[1]["nom"]) ? $userListEntreprise[1]["nom"] : "" ?></p>
        ...
        <div class="flex flex-col justify-end items-center gap-2">
            <div class="overflow-hidden flex items-center justify-center rounded-full h-25 w-25"><img class="h-full w-full scale-110 object-cover" src="<?= isset($userListEntreprise[0]["photo_profil"]) ? $userListEntreprise[0]["photo_profil"] : "../../IMG/default.png" ?>" alt="photo de profil"></div>
            <p class="text-white font-bold"><?= isset($userListEntreprise[0]["prenom"]) ? $userListEntreprise[0]["prenom"] : "" ?> <?= isset($userListEntreprise[0]["nom"]) ? $userListEntreprise[0]["nom"] : "" ?></p>
        ...
        <div class="flex flex-col justify-end items-center gap-2">
            <div class="overflow-hidden flex items-center justify-center rounded-full h-25 w-25"><img class="h-full w-full scale-110 object-cover" src="<?= isset($userListEntreprise[2]["photo_profil"]) ? $userListEntreprise[2]["photo_profil"] : "../../IMG/default.png" ?>" alt="photo de profil"></div>
            <p class="text-white font-bold"><?= isset($userListEntreprise[2]["prenom"]) ? $userListEntreprise[2]["prenom"] : "" ?> <?= isset($userListEntreprise[2]["nom"]) ? $userListEntreprise[2]["nom"] : "" ?></p>
    ...
    <section class="bg-white rounded-t-4xl px-6 pt-8 flex flex-col gap-6 flex-1 pb-50">
        ...
        <?php $i=1; foreach($userListEntreprise as $user): ?>
            <?php  
                $couleur = match($i) {
                    1 => 'text-yellow-400',
                    2 => 'text-slate-300',  
