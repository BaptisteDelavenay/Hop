...
<body class="bg-hop-violet flex flex-col min-h-dvh">
    ...
    <header class="flex items-center justify-center py-8">
        <p class="text-white text-4xl font-bold leading-tight tracking-tight">Nouveau post</p>
    </header>
    ...
    <section class="flex flex-col flex-1 bg-white rounded-t-4xl p-6">
        ...
        <form action="../actions/post.php" enctype="multipart/form-data" method="POST" class="mt-4 flex flex-col space-y-1 w-full ">
            ...
            <label for="image" class="cursor-pointer mb-6 w-full">
                <div id="imgContainer" class="bg-gray-100 h-60 w-full flex items-center justify-center rounded-4xl border border-1 border-gray-400 hover:bg-gray-200 overflow-hidden transition-colors">
            ...
            <div class="w-full flex flex-col mb-6">
                <label for="description" class="text-xs font-bold uppercase text-gray-600 mb-1.5 ml-1 tracking-widest-1">Description</label>
                
                <div class="flex items-start bg-gray-100 min-h-[3.5rem] rounded-2xl px-4 py-3 focus-within:ring-2 focus-within:ring-hop-violet/20 border border-transparent focus-within:border-hop-violet/10 transition-all">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5 text-gray-400 mr-3 mt-0.5">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0115.75 21H5.25A2.25 2.25 0 013 18.75V8.25A2.25 2.25 0 015.25 6H10" />
                    </svg>
                    <textarea class="flex-1 bg-transparent outline-none text-hop-noir placeholder:text-gray-400 text-md resize-none" id="description" name="description" placeholder="Écrivez une courte description ici..." rows="3"required></textarea>
                </div>
            </div>
