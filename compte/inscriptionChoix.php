...
<body class="bg-hop-violet min-h-screen antialiased p-4">
    ...
    <section class="flex flex-col flex-1 gap-6">    
        ...
        <a href="inscriptionCollaborateur.php" class="flex flex-col bg-white h-70 w-11/12 mx-auto p-4 rounded-xl">
        ...
        <a href="inscriptionEntreprise.php" class="flex flex-col bg-white h-70 w-11/12 mx-auto p-4 rounded-xl">
            <div class="flex items-center justify-between">
                <div class="bg-hop-violet p-2 rounded-md">
