        ...
        <form class="flex flex-col justify-center items-center" action="inscriptionEntrepriseEtapeDeux.php" method="POST">
            ...
            <div class="w-full flex flex-col mb-6">
                ...
                <div class="flex items-center bg-gray-100 h-14 rounded-2xl px-4 focus-within:ring-2 focus-within:ring-hop-violet/20 border border-transparent focus-within:border-hop-violet/10 transition-all">
                    ...
                    <input class="flex-1 bg-transparent outline-none text-hop-noir placeholder:text-gray-400 text-md" type="text" id="nomEntreprise" name="nomEntreprise" placeholder="Google" required>
                </div>
            </div>
            ...
            <div class="w-full flex flex-col mb-6">
                ...
                <div class="flex items-center bg-gray-100 h-14 rounded-2xl px-4 focus-within:ring-2 focus-within:ring-hop-violet/20 border border-transparent focus-within:border-hop-violet/10 transition-all">
                    ...
                    <input class="flex-1 bg-transparent outline-none text-hop-noir placeholder:text-gray-400 text-md" type="text" id="activite" name="activite" placeholder="Informatique" required>
                </div>
            </div>
