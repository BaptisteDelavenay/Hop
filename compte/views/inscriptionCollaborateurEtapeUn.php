        ...
        <form class="flex flex-col justify-center items-center" action="inscriptionCollaborateurEtapeDeux.php" method="POST">
            ...
            <div class="flex flex-col w-full mb-10">
                ...
                <div class="relative flex items-center h-14 w-full">
                    ...
                    <input type="text" name="code" id="code" placeholder="code: AVOJ" class="appearance-none w-full h-full bg-gray-100 rounded-2xl pl-12 pr-10 text-md text-gray-400 outline-none valid:text-hop-noir">
                </div>
            </div>
