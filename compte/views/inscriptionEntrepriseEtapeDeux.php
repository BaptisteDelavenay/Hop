...
<body class="bg-hop-violet min-h-dvh flex flex-col">
    ...
    <section class="flex-1 flex flex-col items-center bg-white rounded-t-4xl p-6">
        ...
        <form action="" method="POST" class="flex items-center justify-center flex-col space-y-1 w-full">
            ...
            <label for="photoDeProfil" class="cursor-pointer mb-6">
                ...
                <input type="file" id="photoDeProfil" class="hidden">
            </label>
            ...
            <div class="mt-auto pt-20 flex items-center flex-col gap-6 w-full">
                ...
                <button type="submit" class="bg-hop-vert text-hop-noir text-base font-extrabold w-full h-14 rounded-2xl shadow-xl active:scale-[0.98] transition-all">Suivant</button>
            </div>
